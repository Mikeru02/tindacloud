    ...
    return (
      <div>
        <div className="flex items-center justify-between mb-8">
          <div className="h-9 w-40 bg-[#333] rounded animate-pulse"></div>
          <div className="flex items-center gap-2">
            <div className="h-5 w-12 bg-[#333] rounded animate-pulse"></div>
            <div className="h-10 w-32 bg-[#333] rounded-lg animate-pulse"></div>
          </div>
        </div>
