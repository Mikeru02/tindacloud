...
CREATE TABLE `stores`(
    `id` BIGINT UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY, -- Added UNSIGNED to match users
...
CREATE TABLE `products`(
    ...
    `uuid` CHAR(36) NOT NULL UNIQUE,
    `name` VARCHAR(255) NOT NULL,
    `sku` VARCHAR(64) NULL UNIQUE, -- Fixed typo
    `store_id` BIGINT UNSIGNED NOT NULL, -- Changed to BIGINT UNSIGNED to match stores
